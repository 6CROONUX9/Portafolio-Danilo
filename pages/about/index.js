      ...
      <div className='container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6'>
        ...
        <div className='flex-1 flex flex-col justify-center'>
          ...
          >
            ...
            FRONTEND <span className='text-accent'>DEVELOPER</span>.</motion.h2>
          <motion.p
          ...
          >
            Estudiante de Ingeniería de Sistemas con experiencia en desarrollo web y bases de datos. Habilidades para resolver problemas. Interesado en unirme al equipo y contribuir con proyectos innovadores que superen las expectativas de los clientes.
          </motion.p>
          {/* Contadores animados */}
          <motion.div 
          ...
          >
            <div className='flex flex-1 xl:gap-x-6 mb-2'>
              ...
              <div className='relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0'>
                ...
                <div className='text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px] xl:ml-12'>meses de experiencia</div>
              </div>
              ...
              <div className='relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0'>
                ...
                <div className='text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px] xl:ml-12'>Cliente satisfecho</div>
              </div>
              ...
              <div className='relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0'>
                ...
                <div className='text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px] xl:ml-12'>Proyecto finalizado</div>
              </div>
            </div>
          </motion.div>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className='flex gap-x-4'>
                    {/* Iconos */}
                  {item.icons?.map((icon)=>{
                    return <div key={icon.id}  className='text-2xl'>{icon}</div>;
                  })}
                  </div>
                </div>
              );
